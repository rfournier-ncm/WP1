...
```{r}
#Preregistered model
param_1_pid = EMC2::parameters(LBA_exp1_v1,selection="alpha",map = TRUE)
...
array_theta_pid_1 <- array_theta_1 %>%
  pivot_longer(cols = c("v_Sunf_lMTRUE", "v_Sunf_lMFALSE", "v_Sfam_lMTRUE", "v_Sfam_lMFALSE", "sv_lMTRUE", "B_lRunf", "B_lRfam", "A", "t0"), names_to = "param", values_to = "value")%>%
...
ggsave("/Users/rfournier/Rstudio/EMC_WP1_1/EMC_WP1_1/figures/all_params_1.jpeg",
       width = 8, height = 6)
```
...
ggsave("/Users/rfournier/Rstudio/EMC_WP1_1/EMC_WP1_1/figures/all_params_pid_1.jpeg",
       width = 8, height = 6)
```
...
## save a figure
 ggsave("/Users/rfournier/Rstudio/EMC_WP1_1/EMC_WP1_1/figures/thresh.jpeg",width = 10, height = 6)
```
...
# save a figure
 ggsave("/Users/rfournier/Rstudio/EMC_WP1_1/EMC_WP1_1/figures/thresh.jpeg",
        width = 21, height = 10)
```
...
# save a figure
ggsave("/Users/rfournier/Rstudio/EMC_WP1_1/EMC_WP1_1/figures/thresh_2.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("/Users/rfournier/Rstudio/EMC_WP1_1/EMC_WP1_1/figures/thresh_3.jpeg",
       width = 21, height = 10)
```
...
ggsave("figures/drift_rate_1.jpeg",
        width = 10, height = 6)
```
...
```{r}
p4.1 / p4.2
ggsave("figures/drift_rate_true_false_1.jpeg", 
       width = 16, height = 13)
```
...
# save a figure
ggsave("figures/drift_rat_mini_1.jpeg",
       width = 15, height = 10)
```
...
# save a figure
ggsave("figures/drift_rate_pid_1.jpeg",
       width = 15, height = 10)
```
